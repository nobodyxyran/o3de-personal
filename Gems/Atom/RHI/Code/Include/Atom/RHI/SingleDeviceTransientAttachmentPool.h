...
namespace AZ::RHI
{
    ...
    //! Describes the properties of a SingleDeviceTransientAttachmentPool.
    ...
    {
    public:
        AZ_RTTI(SingleDeviceTransientAttachmentPool, "{D4A544E9-AE4A-4BD7-9E03-646DA8D86388}");

        virtual ~SingleDeviceTransientAttachmentPool() = default;
