...
namespace AZ::RHI
{
    ...
    {
        IterateObjects<SingleDeviceRayTracingShaderTable>([&descriptor](auto deviceIndex, auto deviceShaderTable)
        {
            deviceShaderTable->Build(descriptor->GetDeviceRayTracingShaderTableDescriptor(deviceIndex));
        });
    }
} // namespace AZ::RHI
