...
namespace AZ::RHI
{
    ...
    ResultCode MultiDeviceSwapChain::Resize(const RHI::SwapChainDimensions& dimensions)
    {
        ...
        auto resultCode = IterateObjects<SingleDeviceSwapChain>([&nativeDimensions, &dimensions]([[maybe_unused]] auto deviceIndex, auto deviceSwapChain)
        {
            auto resultCode = deviceSwapChain->Resize(dimensions);
